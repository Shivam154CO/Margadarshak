                  ...
                  <div className="flex items-center space-x-6">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        {/* DigiLocker Verification Badge / Button */}
                        {isDigilockerVerified ? (
                          <div className="inline-flex items-center space-x-1.5 bg-green-500/20 text-green-100 backdrop-blur-sm rounded-full px-3 py-1 border border-green-500/30 shadow-[0_0_15px_rgba(34,197,94,0.3)]">
                            <ShieldCheck className="w-3.5 h-3.5 text-green-400" />
                            <span className="text-xs font-bold tracking-wide">Verified Authentic ✅</span>
                          </div>
                        ) : (
                          <button
                            onClick={() => setIsAuthenticating(true)}
                            className="inline-flex items-center space-x-1.5 bg-blue-500/20 hover:bg-blue-500/40 text-blue-100 backdrop-blur-sm rounded-full px-3 py-1 border border-blue-500/30 transition-all cursor-pointer group"
                          >
                            <ShieldAlert className="w-3.5 h-3.5 text-blue-400 group-hover:animate-pulse" />
                            <span className="text-xs font-bold tracking-wide">Link DigiLocker</span>
                          </button>
                        )}
                      </div>
                    </div>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
              ...
              >
                <div className="bg-gradient-to-r from-blue-600 to-indigo-700 px-6 py-8 text-center relative">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-1">DigiLocker Verification</h3>
                  <p className="text-blue-100 text-sm">Government of India Document Integration</p>
                </div>
                ...
                <div className="p-8 pb-10">
                  {authStep === 0 && (
                    <div className="text-center">
                      <p className="text-slate-600 mb-6 leading-relaxed">
                        By securely linking your DigiLocker account, SmartCF will automatically fetch your verified 12th/Diploma marksheets and caste certificate directly from government servers.
                      </p>
                      <button
                        onClick={() => {
                          setAuthStep(1);
                          setTimeout(() => setAuthStep(2), 2500);
                          setTimeout(() => {
                        ...
                        className="w-full bg-slate-900 hover:bg-slate-800 text-white font-bold py-3.5 rounded-xl transition-all shadow-lg flex justify-center items-center space-x-2"
                      >
                  ...
                  {authStep === 1 && (
                    <div className="text-center py-6">
                      ...
                      <h4 className="text-lg font-bold text-slate-900 mb-2">Connecting to Open-API...</h4>
                      <p className="text-slate-500 text-sm">Waiting for DigiLocker gateway response</p>
                    </div>
                  )}
                  ...
                  {authStep === 2 && (
                    <div className="text-center py-6">
                      ...
                      <h4 className="text-lg font-bold text-slate-900 mb-2">Fetching Documents...</h4>
                      <p className="text-slate-500 text-sm animate-pulse">Downloading verified Marksheet & Certificate</p>
                    </div>
                  )}
                  ...
                  {authStep === 3 && (
                    <div className="text-center py-6">
                      ...
                      <h4 className="text-xl font-bold text-slate-900 mb-2">Verified Authentic ✅</h4>
                      <p className="text-slate-500 text-sm">Your documents were successfully validated.</p>
                    </div>
                  )}
                </div>
              </motion.div>
